...
public class StrTest
{
  ...
  public void testStrPointer() {
    System.out.println("Testing the construtor Str(Pointer cstr) of the Str class");
    Str s = new Str("ATATAT");
  ...
  public void testStrString() {
    System.out.println("Testing the constructor Str(String string) of the Str class");
    Str s = new Str("ATATAT");
    assertTrue(s.length() == 6);
    assertTrue(s.to_ptr() != null);
    assertTrue(s.to_s().equals("ATATAT"));
